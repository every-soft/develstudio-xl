...
global $_c;
$_c->setConstList(array('gdHorizontal', 'gdVertical'), 0);
$_c->setConstList(array('cbfVertical', 'cbfHorizontal'), 0);
...
class TCategoryButtons extends TControl 
{
    ...
    public function addSection($group, $caption, $color = 0xD7D7D7)
	{
	...
	{
		$this->buttonOptions = $v ? 'boGradientFill,boBoldCaptions,boUsePlusMinus,boCaptionOnlyBorder' : 'boShowCaptions,boFullSize,boGradientFill,boBoldCaptions,boUsePlusMinus,boCaptionOnlyBorder';
    }
