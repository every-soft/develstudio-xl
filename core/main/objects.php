...
class TObject extends _Object {
	...
	{
		return rtii_class ($this->self); // gui_class()
    }
	...
	{
        $this->self = component_create (__CLASS__, nil); // gui_create ()
    }
...
function obj_create ($class, $onwer)
{
	if (is_object($onwer) && property_exists($onwer, 'self')){
		return component_create($class, $onwer->self); // gui_create()
	}
	else
		return component_create($class, nil); // gui_create()
}
...
class TComponent extends TObject {
	...
	function __getPropEx($nm)
	{
		...
		if (isset($result['PARAMS'][strtolower($nm)]))
...
class TFont extends _Object {
	...
	function set_orientation($orientation){ gui_propset( gui_propGet( $this->self, 'Font'), 'Orientation', $orientation); }
	function set_pitch($pitch){ gui_propset( gui_propGet( $this->self, 'Font'), 'Pitch', $pitch); }
	function set_height($height){ gui_propset( gui_propGet( $this->self, 'Font'), 'Height', $height); }
	...
	function get_orientation(){ return gui_propGet( gui_propGet( $this->self, 'Font'), 'Orientation'); }
	function get_pitch(){ return gui_propGet( gui_propGet( $this->self, 'Font'), 'Pitch'); }
	function get_height(){ return gui_propGet( gui_propGet( $this->self, 'Font'), 'Height'); }
	function get_style(){
...
class TRealFont extends TFont {
	...
	function set_pitch($pitch){ $this->propSet('pitch',$pitch); }
	function set_orientation($orientation){$this->propSet('orientation',$orientation);}
	function set_height($height){$this->propSet('height',$height);}
	
	function get_name(){ return $this->prop('name'); }
	function get_color(){ return $this->prop('color'); }
	function get_size(){ return $this->prop('size'); }
	function get_charset(){ return $this->prop('charset'); }
	function get_pitch(){ return $this->prop('pitch'); }
	function get_orientation(){ return $this->prop('orientation'); }
	function get_height(){ return $this->prop('height'); }
...
class TControl extends TComponent {
	...
	function get_fontorientation()  { return $this->font->orientation; }
	function set_fontorientation($v){ $this->font->orientation = $v; } */
	...
	function set_popupMenu($menu){
		if (is_object($menu) && property_exists($menu, 'self'))
	...
	function set_hint($hint){
	    ...
	    $this->showHint = (bool)$hint; // genius
