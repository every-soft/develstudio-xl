...
class TCanvasFont extends TFont 
{
	...
	function set_height($height){ rtii_set($this,'height',$height); }
	function set_orientation($orientation){ rtii_set($this,'orientation',$orientation); }
	function set_pitch($pitch){ rtii_set($this,'pitch',$pitch); }
