...
global $SCREEN, $fmEdit, $fmComponents, $fmMain;
...
{  
    ...
    if ($dsg_cfg->fmPHPEditor->x)
	{
        ...
        c('fmPHPEditor')->x = $dsg_cfg->fmPHPEditor->x;
        c('fmPHPEditor')->y = $dsg_cfg->fmPHPEditor->y;
        c('fmPHPEditor')->w = $dsg_cfg->fmPHPEditor->w;
        c('fmPHPEditor')->h = $dsg_cfg->fmPHPEditor->h;
        c('fmPHPEditor')->windowState = $dsg_cfg->fmPHPEditor->wS;
    }
    
    $fmMain->caption = 'DevelStudio XL'/*. DV_YEAR*/;
