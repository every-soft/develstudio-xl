...
$result[] = array(
                  'CAPTION'=>t('rowH'),
                  'PROP'=>'rowH',
                  'INLINE'=>'int rowH ( int index [, int h] )',
                  );

$result[] = array(
                  'CAPTION'=>t('colW'),
                  'PROP'=>'colW',
                  'INLINE'=>'int colW ( int index [, int w] )',
                  );

$result[] = array(
                  'CAPTION'=>t('rowHeight'),
                  'PROP'=>'rowHeight',
                  'INLINE'=>'int rowHeight ( int index [, int h] )',
                  );

$result[] = array(
                  'CAPTION'=>t('colWidth'),
                  'PROP'=>'colWidth',
                  'INLINE'=>'int colWidth ( int index [, int w] )',
                  );

$result[] = array(
                  'CAPTION'=>t('get_rowsHeight'),
                  'PROP'=>'get_rowsHeight',
                  'INLINE'=>'array get_rowsHeight ( void )',
                  );
...
$result[] = array(
                  ...
                  'PROP'=>'get_colsWidth',
                  'INLINE'=>'array get_colsWidth ( void )',
                  );
...
$result[] = array(
                  ...
                  'PROP'=>'get_rowsText',
                  'INLINE'=>'array get_rowsText ( [, boolean fixed = true] )',
                  );
...
$result[] = array(
                  ...
                  'PROP'=>'get_colsText',
                  'INLINE'=>'array get_colsText ( [, boolean fixed = true] )',
                  );
