object fmEasySelectDialog: TfmEasySelectDialog
  ...
  object line: TSynEdit
	...
	Options = [eoAutoIndent, eoDragDropEditing, eoEnhanceEndKey, eoGroupUndo, eoHalfPageScroll, eoHideShowScrollbars, eoScrollPastEof, eoShowScrollHint, eoSmartTabDelete, eoTabIndent, eoTrimTrailingSpaces]
    ScrollBars = ssNone
  end
