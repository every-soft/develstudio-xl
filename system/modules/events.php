...
class __exEvents {
	...
	/* *********************************************** */
    static function callCodeMouseActivate ($_self, $button, $shift, $x, $y, $hitTest, &$mouseActivate, $_eventName)
	{
        $self   = c($_self);
	...
	static function callCodeMouseWheel ($_self, $shift, $wheelDelta, $x, $y, &$handled, $_eventName)
	{
        $self   = c($_self);
	...
	static function callCodeMouseWheelUp ($_self, $shift, $x, $y, &$handled, $_eventName)
	{
        $self   = c($_self);
	...
	static function callCodeMouseWheelDown ($_self, $shift, $x, $y, &$handled, $_eventName)
	{
        $self   = c($_self);
    ...
    static function callCodeCanResize ($_self, $newWidth, $newHeight, &$canResize, $_eventName)
	{
        $self   = c($_self);
    ...
    static function callCodeChanging ($_self, &$allowChange, $_eventName)
	{
        $self   = c($_self);
	...
	/* **************************************************************** */
	static function OnCanResize($self, $newWidth, $newHeight, &$canResize){ self::callCodeCanResize($self, $newWidth, $newHeight, $canResize, __FUNCTION__); }
    /* **************************************************************** */
	...
	static function OnHide($self){ self::callCode($self, __FUNCTION__); }
	
	
	/* **************************************************************** */
    static function OnMouseActivate($self, $button, $shift, $x, $y, $hitTest, &$mouseActivate){ self::callCodeMouseActivate($self, $button, $shift, $x, $y, $hitTest, $mouseActivate, __FUNCTION__); }
	
    static function OnMouseWheel($self, $shift, $wheelDelta, $x, $y, &$handled){ self::callCodeMouseWheel($self, $shift, $wheelDelta, $x, $y, &$handled, __FUNCTION__); }  
    static function OnMouseWheelUp($self, $shift, $x, $y, &$handled){ self::callCodeMouseWheelUp($self, $shift, $x, $y, &$handled, __FUNCTION__); }  
    static function OnMouseWheelDown($self, $shift, $x, $y, &$handled){ self::callCodeMouseWheelDown($self, $shift, $x, $y, &$handled, __FUNCTION__); }  
	
	static function OnChanging($self, &$allowChange){ self::callCodeChanging($self, $allowChange, __FUNCTION__); }
...
// Register Event Types with Parametres
...
DSApi::reg_eventParams('onMouseActivate', array('self', 'button', 'shift', 'x', 'y', 'hitTest', '&mouseActivate')); // new
DSApi::reg_eventParams('onMouseUp', array('self','button','shift','x','y'));
DSApi::reg_eventParams('onMouseMove', array('self','shift','x','y'));
DSApi::reg_eventParams('onMouseWheel', array('self','shift', 'wheelDelta', 'x', 'y', '&handled')); // new
DSApi::reg_eventParams('onMouseWheelUp', array('self','shift', 'x', 'y', '&handled')); // new
DSApi::reg_eventParams('onMouseWheelDown', array('self','shift', 'x', 'y', '&handled')); // new
DSApi::reg_eventParams('onCloseQuery', array('self','&canClose'));
DSApi::reg_eventParams('onCanResize', array('self','newWidth','newHeight','&canResize')); // new
DSApi::reg_eventParams('onScroll', array('self','scrollCode', '&scrollPos'));
DSApi::reg_eventParams('onChanging', array('self','&allowChange')); // new
